...
paper = {"rating": 3.0, 
     "title" : "Safety of new drugs for diabetes: Getting the balance right?", 
...
dummypapers = [paper,paper,paper,paper]
...
//     $.post( "http://localhost:5000/uploadwords", 
//             input = JSON.stringify({words:words, allpapers:allpapers}), 
//             success=function( response ) {
//               parsed_document = JSON.parse(response)
//               allpapers = display_papers(parsed_document)
//               return;
//             }); 
//     display_papers(dummypapers);
// }
